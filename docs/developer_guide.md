...
## Environment
Follow the installation instructions in the section [Install standalone application directly from the source](installation.md#install-standalone-application-directly-from-the-source).
